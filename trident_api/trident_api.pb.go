...
type PingPoseidonClient interface {
	...
	// REST greeting
	Get_Poseidon(ctx context.Context, in *HelloPoseidon, opts ...grpc.CallOption) (*PoseidonReply, error)
}
...
func (c *pingPoseidonClient) Get_Poseidon(ctx context.Context, in *HelloPoseidon, opts ...grpc.CallOption) (*PoseidonReply, error) {
	out := new(PoseidonReply)
	err := grpc.Invoke(ctx, "/trident.PingPoseidon/get_Poseidon", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PingPoseidonServer interface {
	...
	// REST greeting
	Get_Poseidon(context.Context, *HelloPoseidon) (*PoseidonReply, error)
}
...
func _PingPoseidon_Get_Poseidon_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloPoseidon)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PingPoseidonServer).Get_Poseidon(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/trident.PingPoseidon/Get_Poseidon",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingPoseidonServer).Get_Poseidon(ctx, req.(*HelloPoseidon))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PingPoseidon_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "get_Poseidon",
			Handler:    _PingPoseidon_Get_Poseidon_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	0xc4, 0x74, 0x98, 0x3a, 0x18, 0xd7, 0xe8, 0x2f, 0x23, 0x17, 0x4f, 0x40, 0x66, 0x5e, 0x3a, 0xdc,
	0x3c, 0x7b, 0x2e, 0x6e, 0xf7, 0xd4, 0x12, 0x38, 0x57, 0x4c, 0x0f, 0xea, 0x2e, 0x3d, 0x14, 0x6b,
	0xa5, 0x10, 0xe2, 0x28, 0x36, 0x29, 0x31, 0x08, 0xb9, 0x70, 0x09, 0x20, 0x19, 0xe0, 0x98, 0x9e,
	0x98, 0x49, 0x8e, 0x29, 0x69, 0x5c, 0x3c, 0xe9, 0xa9, 0x25, 0xf1, 0x64, 0xbb, 0x43, 0xad, 0xe9,
	0xf2, 0x93, 0xc9, 0x4c, 0x0a, 0x4a, 0xd2, 0xfa, 0x65, 0x86, 0xfa, 0xa9, 0x15, 0x89, 0xb9, 0x05,
	0x39, 0xa9, 0xfa, 0x41, 0xa9, 0xc5, 0x25, 0x48, 0x6e, 0xb3, 0x62, 0xd4, 0x4a, 0x62, 0x03, 0x07,
	0xab, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x5e, 0x3e, 0x71, 0xc6, 0x92, 0x01, 0x00, 0x00,
}
