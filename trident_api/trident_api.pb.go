...
type PingPoseidonClient interface {
	...
	// REST greeting
	RestGetPoseidon(ctx context.Context, in *HelloPoseidon, opts ...grpc.CallOption) (*PoseidonReply, error)
}
...
func (c *pingPoseidonClient) RestGetPoseidon(ctx context.Context, in *HelloPoseidon, opts ...grpc.CallOption) (*PoseidonReply, error) {
	out := new(PoseidonReply)
	err := grpc.Invoke(ctx, "/trident.PingPoseidon/RestGetPoseidon", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PingPoseidonServer interface {
	...
	// REST greeting
	RestGetPoseidon(context.Context, *HelloPoseidon) (*PoseidonReply, error)
}
...
func _PingPoseidon_RestGetPoseidon_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloPoseidon)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PingPoseidonServer).RestGetPoseidon(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/trident.PingPoseidon/RestGetPoseidon",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingPoseidonServer).RestGetPoseidon(ctx, req.(*HelloPoseidon))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PingPoseidon_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RestGetPoseidon",
			Handler:    _PingPoseidon_RestGetPoseidon_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
